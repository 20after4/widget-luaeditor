...
cprequire_test(["inline:com-chilipeppr-widget-pythoneditor"], function(myWidget) {
    ...
    $('#com-chilipeppr-widget-pythoneditor').css('margin', '10px');
    ...
    var testLoadScript = function() {
        ...
        chilipeppr.publish("/com-chilipeppr-widget-pythoneditor/loadScript", file);
    }
    ...
    //$('#' + myWidget.id + ' .pythoneditor-uploadrun').trigger("click");

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-widget-pythoneditor", ["chilipeppr_ready", "aceAutoCompletion", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-widget-pythoneditor", // Make the id the same as the cpdefine id
        ...
        subscribe: {
            ...
            '/loadScript': 'Publish an object of {name:"myfile.python", content:"print(\\"hello world\\")"} and we will open a new tab with the contents of the file.'
        },
        /**
        ...
        init: function () {
            ...
            $('#' + this.id + ' .pythoneditor-new').click(this.fileNew.bind(this));
            $('#' + this.id + ' .pythoneditor-run').click(this.runScript.bind(this));

            // saveScript
            //$('#' + this.id + ' .pythoneditor-save').click(this.saveScript.bind(this));
            $('#' + this.id + ' .pythoneditor-save').click(this.fileLocalSave.bind(this));
            ...
            $('#' + this.id + ' .pythoneditor-maineditor').keypress(this.jscriptKeypress.bind(this));
        ...
        loadScript: function(data) {
            ...
            filename = filename.replace(/\.python$/, "");
            ...
            if (id in this.aceSessions) {
                ...
                // creating one
                var session = new ace.EditSession(content, "ace/mode/python")
...
`;
         ...
         */
        aceId: "com-chilipeppr-pythoneditor",
        aceSessionName: null,
        aceSessions: {},
        ...
        loadAce: function(sessionName) {
            ...
            if ('ace' in window && ace) { // && 'setValue' in ace) {
                ...
                //var docu = ace.createEditSession('', "ace/mode/python");
                ...
                if (this.aceSessionName in this.aceSessions) {
                    ...
                    this.aceCurrentSession = new ace.EditSession('', "ace/mode/python")
...
<li class="active li-template"><a
    ...
    class="tab-file-name">udp.python</span></a><button
    ...
    aria-hidden="true">×</span></button>
            ...
            filename = filename.replace(/\.python$/, "");
            tmpltEl.find(".tab-file-name").text(filename + ".python");
            ...
            $('#' + this.id + ' .pythoneditor-maineditor').removeClass("empty");
        ...
        onFileTabClose: function(e) {
            ...
            if (Object.keys(this.aceSessions).length == 0) {
                ...
                $('#' + this.id + ' .pythoneditor-maineditor').addClass("empty");
        ...
        renameFile: function() {
            ...
            tabSpan.text(newfilename + ".python");
        ...
        getActiveFile: function() {
            ...
            //var activeEl = $('#' + this.id + " .pythoneditor-maineditor.active");
        ...
        fileLocalSave: function(evt) {
            ...
            $('#' + this.id + ' .pythoneditor-save').popover('hide');

            $('#' + this.id + ' .pythoneditor-save').addClass('active');
            var that = this;
            setTimeout(function() {
                $('#' + that.id + ' .pythoneditor-save').removeClass('active');
            }, 500);
        ...
        fileDelete: function(evt) {
            ...
            //filename += ".python";
            this.send('file.remove("' + filename + '.python", "r")');
        ...
        cleanupFilename: function() {
            ...
            if (fileName && fileName.length > 0) {
                ...
                // make sure there's no .python extension
                if (fileName.match(/\.python$/i)) {
                    fileEl.val(fileName.replace(/\.python$/i, ""));
                    fileName = fileEl.val();
                }
                //return fileName;
            } else {
        ...
        setupUploadRun: function() {
            $('#' + this.id + ' .pythoneditor-uploadrun').click(this.onOpenUploadRunRegion.bind(this));
             // activate alert
        ...
        onOpenUploadRunRegion: function(evt) {
            ...
            var btnEl = $('#' + this.id + ' .pythoneditor-uploadrun');
            btnEl.popover('hide');
        ...
        onCloseUploadRunRegion: function() {
            $('#' + this.id + ' .pythoneditor-uploadrun').removeClass("active");
        ...
        setupStartup: function() {
            ...
            $('#' + this.id + ' .pythoneditor-startup-load').click(this.editStartup.bind(this));
            $('#' + this.id + ' .pythoneditor-startup-save').click(this.saveStartup.bind(this));
        ...
        makeTextareaAcceptTabs: function() {
            $(document).delegate('#' + this.id + ' .pythoneditor-maineditor', 'keydown', function(e) {
        ...
        getScript: function() {
            //this.jscript = $('#' + this.id + ' .pythoneditor-maineditor').val();
        ...
        runScript: function(macroStr, helpTxt) {
            ...
            // hide popover
            $('#' + this.id + ' .pythoneditor-run').popover('hide');
        ...
        jscriptKeypress: function(evt) {
            ...
            if (evt.ctrlKey && evt.keyCode == 10) {
                ...
                this.runScript();
                // mimic push on btn
                $('#' + this.id + ' .pythoneditor-run').addClass('active');
                var that = this;
                setTimeout(function() {
                    $('#' + that.id + ' .pythoneditor-run').removeClass('active');
                }, 200);
            }
        ...
        setScriptFromTemporaryFile: function() {
            ...
            if (this.jscript) {
                $('#' + this.id + ' .pythoneditor-maineditor').val(this.jscript);
        ...
        buildRecentFileMenu: function() {
            ...
            for (var i = 0; i < localStorage.length; i++){
                console.log("localStorage.item.key:", localStorage.key(i));
                var key = localStorage.key(i);
                if (key.match(/com-chilipeppr-widget-pythoneditor-recent(\d+)-name/)) {
                    //localStorage.removeItem(key);
                    var keyCtr = RegExp.$1;
        ...
        resize: function() {
            ...
            //var logEl = $('#' + this.id + ' .pythoneditor-maineditor');
        ...
        loadJscript: function(txt) {
            //this.jscript = txt;
            //$('#' + this.id + ' .pythoneditor-maineditor').val(txt);
